...
@Data
@Schema(description = "Полная информация о заявке на обслуживание оборудования")
public class ServiceFullRequestResponse {
    ...
    @Schema(
            description = "Информация об оборудовании, для которого создана заявка"
    )
